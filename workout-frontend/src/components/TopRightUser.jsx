...
function TopRightUser() {
    ...
    return (
        ...
        <div
            className="flex items-center gap-4 mt-5 mr-4 mb-2 whitespace-nowrap"
            data-testid="top-right-user"
        >
            {/* Display logged-in user's username */}
            <span
                className="text-grey-800 font-medium"
                data-testid="top-right-username"
            >
                {username}
            </span>
            ...
            <button
                data-testid="top-right-logout-button"
