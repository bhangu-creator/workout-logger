...
function CustomTooltip({ active, payload }) {
    ...
    return (
        ...
        <div
            ...
            data-testid="workout-type-tooltip"
        >
            {/* Workout type / category name */}
            <p className="font-semibold" data-testid="workout-type-tooltip-name">
                {name}
            </p>

            {/* Total number of workouts for this category */}
            <p data-testid="workout-type-tooltip-count">Workouts: {count}</p>

            {/* Total calories burned for this category */}
            <p data-testid="workout-type-tooltip-kcal">Kcal Burned: {kcal}</p>

            {/* Percentage share of this category in the pie chart */}
            <p data-testid="workout-type-tooltip-share">Share: {value}%</p>
        </div>
    );
}
